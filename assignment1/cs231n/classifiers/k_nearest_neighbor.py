...
class KNearestNeighbor(object):
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in xrange(num_test):
            for j in xrange(num_train):
                ...
                dists[i, j] = np.sqrt(np.sum(delta**2))
                #####################################################################
                #                       END OF YOUR CODE                            #
                #####################################################################
        return dists
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in xrange(num_test):
            ...
            #######################################################################
            test_vec = X[i]
            delta = np.tile(test_vec, (num_train, 1)) - self.X_train
            dists[i, :] = np.sqrt(np.sum(delta**2, axis=1))
            #######################################################################
            #                         END OF YOUR CODE                            #
            #######################################################################
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in xrange(num_test):
            ...
            largest_count = -1
            for index, y in enumerate(unique):
                if counts[index] > largest_count:
                    largest_count = counts[index]
                    y_pred[i] = y
            #########################################################################
            #                           END OF YOUR CODE                            #
            #########################################################################
